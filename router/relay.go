...
func SetRelayRouter(router *gin.RouterGroup) {
	...
	relayV1Router.Use(middleware.RelayPanicRecover(), middleware.TokenAuth(), middleware.Distribute())
	{
		...
		// 飞桨模型API路由
		relayV1Router.POST("/ocr", controller.Relay)
		relayV1Router.POST("/table-recognition", controller.Relay)
		relayV1Router.POST("/layout-parsing", controller.Relay)
		relayV1Router.POST("/formula-recognition", controller.Relay)
		relayV1Router.POST("/seal-recognition", controller.Relay)
		relayV1Router.POST("/document-preprocessing", controller.Relay)
		relayV1Router.POST("/image-classification", controller.Relay)
		relayV1Router.POST("/object-detection", controller.Relay)
		relayV1Router.POST("/instance-segmentation", controller.Relay)
		relayV1Router.POST("/semantic-segmentation", controller.Relay)
		relayV1Router.POST("/multilabel-image-classification", controller.Relay)
		relayV1Router.POST("/small-object-detection", controller.Relay)
		relayV1Router.POST("/anomaly-detection", controller.Relay)
		relayV1Router.POST("/rotated-object-detection", controller.Relay)
		relayV1Router.POST("/shitu-index-build", controller.Relay)
		relayV1Router.POST("/face-recognition-index-build", controller.Relay)
